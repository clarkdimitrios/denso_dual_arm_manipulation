...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/safe_go_to_pose.launch.py']),
        ('share/' + package_name + '/launch', ['launch/safe_waypoints.launch.py']),
        ('share/' + package_name + '/launch', ['launch/dual_waypoints.launch.py']),
        ('share/' + package_name + '/launch', ['launch/safe_optim_waypoints.launch.py']),
        # ('share/' + package_name + '/launch', ['launch/multi_robot_bringup.launch.py']),
        ('share/' + package_name + '/launch', ['launch/comb_multi_robot_bringup.launch.py']),
